...
// CREATE POST
if (document.getElementById("createpost-container")) {
  ...
  createpostForm.addEventListener("submit", (e) => {
    ...
    if (groupname === "" || classname === "") {
      ...
      newPost.innerHTML = `<div class="post"><p class="post-meta"><span>${classname} </span>&#x2022 posted by ${username}</p>\
  <h4>${groupname}</h4><p>${body}</p></div>`;
      let newPosts = newPost.innerHTML + posts;
